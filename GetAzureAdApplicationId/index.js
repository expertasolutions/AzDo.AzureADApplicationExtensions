...
;
function FindAzureServicePrincipal(applicationName, graphClient) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, graphClient.servicePrincipals.list(appFilter)];
                case 1:
...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var azureEndpointSubscription, applicationName, subcriptionId, servicePrincipalId, servicePrincipalKey, tenantId, azureCredentials, pipeCreds, graphClient, servicePrincipalInstance, permissionString, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 1:
                    ...
                    return [4 /*yield*/, FindAzureServicePrincipal(applicationName, graphClient)];
                case 2:
                    servicePrincipalInstance = _a.sent();
                    if (servicePrincipalInstance === null) {
                        ...
                        tl.setVariable("azureAdApplicationId", servicePrincipalInstance.appId);
                        console.log("Set the Azure Permission Access ...");
                        permissionString = JSON.stringify(servicePrincipalInstance.oauth2Permissions);
